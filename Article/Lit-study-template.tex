...
\begin{enumerate}
    \item Only agent $i$ should have access to $x_i,f_i $.
    \item Neither devices, nor the operator should have access to plaintext value of $\y_ij$.
    \item Neither devices, nor operator should have access to plaintext values of$y^{ij}$.
\end{enumerate}
